 ...
 const [isOpen, setIsOpen] = useState(false);
  ...
  return (
    ...
    <span className="absolute left-[-23px] flex items-center justify-center w-12 h-12 bg-blue-100 rounded-full -start-4 ring-8 ring-white">
        ...
        }} htmlFor="react-option" className="inline-flex items-center h-12 w-12 justify-between  rounded-full text-gray-500 bg-blue-100 border-2 cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:bg-green-500   peer-checked:ring-white peer-checked:text-white peer-checked:border-success hover:text-gray-600 dark:peer-checked:text-gray-300 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">                           
        ...
        <span>
        <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Scheduled for April 15th, 2024</time><label  className="items-center me-5 cursor-pointer flex">
