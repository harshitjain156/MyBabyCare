...
export function MeetingDetailsScreen({
  ...
  const [flag, setFlag]= useState(iscreateMeetingClicked);
  const [meetingIdError, setMeetingIdError] = useState(false);
  const [isCopied, setIsCopied] = useState(false);
  // const [iscreateMeetingClicked, setIscreateMeetingClicked] = useState(false);
  const [isJoinMeetingClicked, setIsJoinMeetingClicked] = useState(false);

  console.log(iscreateMeetingClicked, meetingId);
      ...
      {iscreateMeetingClicked ? (
        ...
        <>
          <input
            ...
            onChange={(e)=>setMeetingIdHandler(e)}
      ...
      {!iscreateMeetingClicked && !isJoinMeetingClicked && (
        <div className="w-full md:mt-0 mt-4 flex flex-col">
          <div className="flex items-center justify-center flex-col w-full ">
            <h1 className="text-3xl">Are you ready to join?</h1>
            {/* <button
            ...
            {/* <button
              className="w-full bg-gray-650 text-black bg-secondary px-2 py-3 rounded-xl mt-5"
              onClick={(e) => {
            ...
            <button
              className="w-full bg-purple-350 text-white bg-secondary hover:bg-secondary-dark mt-5 px-2 py-3 rounded-xl"
              onClick={(e) => {
                setIsJoinMeetingClicked(true);
              }}
            >
